...
CREATE TABLE tip(tip_id VARCHAR, tipper_id VARCHAR, game_id VARCHAR, created_at VARCHAR, updated_at VARCHAR, league VARCHAR, tip_play VARCHAR, tip_type VARCHAR, PRIMARY KEY(tip_id));
